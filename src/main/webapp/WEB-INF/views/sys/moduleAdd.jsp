...
<head>
    ...
    <link href="${staticServer}/assets/css/jquery.minicolors.css" rel="stylesheet" type="text/css"/>
    <link rel="stylesheet" href="<c:url value="/assets/iconpicker/bootstrap-iconpicker.css"/>"/>
</head>
...
<div class="main-container" id="main-container">
    ...
    <div class="main-content">
        <div class="main-content-inner">
                        ...
                        <form id="moduleForm" name="moduleForm" class="form-horizontal" action="add.htm" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <input id="parent_id" type="text" name="parent_id" readonly="readonly"
                                           hidden="hidden" class="col-xs-10 col-sm-5" placeholder="" value="">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input id="iconImg" type="hidden" name="iconImg" class="col-xs-10 col-sm-5"
                                           placeholder="" value="">
                                    <div id="icon-picker" data-iconset="fontawesome" data-search="true"
                                         data-search-text="查询..." data-align="left" data-cols="13" data-rows="6"></div>
                                    <label id="iconImgTip"></label>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label">图标颜色：</label>
                                <div class="col-sm-9">
                                    <div class="input">
											<span class="input-icon input-icon-right"> <input
                                                    type="text" id="icon_color" name="icon_color"
                                                    class="form-control demo" data-control="wheel"
                                                    value="">
											</span>
                                    </div>
                                    <label id="icon_colorTip"></label>
                                </div>
                            </div>
                            <div class="form-group">
            ...
            <script src="<c:url value="/assets/iconpicker/iconset/iconset-fontawesome-4.2.0.js"/>"></script>
            <!-- Bootstrap-Iconpicker -->
            <script src="<c:url value="/assets/iconpicker/bootstrap-iconpicker.js"/>"></script>
            <script src="${staticServer}/assets/js/jquery.minicolors.js"></script>
            <script src="${staticServer}/assets/js/components-color-pickers.min.js"></script>
            ...
            <script type="text/javascript">
                ...
                $(document).ready(function () {
                    $('#icon-picker').iconpicker().on('change', function (e) {
                        $('#iconImg').val(e.icon);
                    });
